 ...
 611:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 98 0a 00 00    	mov    %edx,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f7:	73 4f                	jae    748 <malloc+0xa8>
    ...
    if(p == freep)
 6f9:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 ...
 76e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 792:	00 00 00 
    if(p->s.size >= nunits){
