 ...
 601:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 58 0a 00 00    	mov    %edx,0xa58
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 58 0a 00 00    	mov    %edx,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 58 0a 00 00       	mov    0xa58,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 58 0a 00 00       	mov    %eax,0xa58
}
