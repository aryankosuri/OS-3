...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     2a0:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    exit();
     ...
     2ce:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     2e5:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     5de:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     5f7:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     793:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     7aa:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     7c3:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     7de:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 3c 5e 00 00    	pushl  0x5e3c
     9e1:	e8 5a 30 00 00       	call   3a40 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 40 5e 00 00       	push   $0x5e40
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    303e:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3059:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3073:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3092:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    30a9:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    30c0:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    30d7:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    30ee:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    311d:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3134:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    314b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3162:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    322b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3293:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 80 a5 00 00 	movl   $0x5410,0xa580(,%eax,4)
    3317:	10 54 00 00 
    ...
    332a:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    args[MAXARG-1] = 0;
    ...
    3357:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    3387:	ff 35 3c 5e 00 00    	pushl  0x5e3c
    ...
    339e:	ff 35 3c 5e 00 00    	pushl  0x5e3c
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 38 5e 00 00 0d 	imul   $0x19660d,0x5e38,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 38 5e 00 00       	mov    %eax,0x5e38
}
    3674:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3a51:	0f 84 b8 00 00 00    	je     3b0f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
  ...
  ap = (uint*)(void*)&fmt + 1;
    ...
    3a65:	eb 37                	jmp    3a9e <printf+0x5e>
  ...
  write(fd, &c, 1);
    ...
    3a89:	e8 65 fe ff ff       	call   38f3 <write>
    3a8e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3a91:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3a94:	0f b6 1e             	movzbl (%esi),%ebx
    3a97:	83 c6 01             	add    $0x1,%esi
    3a9a:	84 db                	test   %bl,%bl
    3a9c:	74 71                	je     3b0f <printf+0xcf>
    c = fmt[i] & 0xff;
    3a9e:	0f be cb             	movsbl %bl,%ecx
    3aa1:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3aa4:	85 d2                	test   %edx,%edx
    3aa6:	74 c8                	je     3a70 <printf+0x30>
      }
    } else if(state == '%'){
    3aa8:	83 fa 25             	cmp    $0x25,%edx
    3aab:	75 e7                	jne    3a94 <printf+0x54>
      if(c == 'd'){
    3aad:	83 f8 64             	cmp    $0x64,%eax
    3ab0:	0f 84 9a 00 00 00    	je     3b50 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3ab6:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3abc:	83 f9 70             	cmp    $0x70,%ecx
    3abf:	74 5f                	je     3b20 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3ac1:	83 f8 73             	cmp    $0x73,%eax
    3ac4:	0f 84 d6 00 00 00    	je     3ba0 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3aca:	83 f8 63             	cmp    $0x63,%eax
    3acd:	0f 84 8d 00 00 00    	je     3b60 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3ad3:	83 f8 25             	cmp    $0x25,%eax
    3ad6:	0f 84 b4 00 00 00    	je     3b90 <printf+0x150>
  write(fd, &c, 1);
    3adc:	83 ec 04             	sub    $0x4,%esp
    3adf:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3ae3:	6a 01                	push   $0x1
    3ae5:	57                   	push   %edi
    3ae6:	ff 75 08             	pushl  0x8(%ebp)
    3ae9:	e8 05 fe ff ff       	call   38f3 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    3aee:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    3af1:	83 c4 0c             	add    $0xc,%esp
    3af4:	6a 01                	push   $0x1
  for(i = 0; fmt[i]; i++){
    3af6:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    3af9:	57                   	push   %edi
    3afa:	ff 75 08             	pushl  0x8(%ebp)
    3afd:	e8 f1 fd ff ff       	call   38f3 <write>
  for(i = 0; fmt[i]; i++){
    3b02:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
    3b06:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    3b09:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
    3b0b:	84 db                	test   %bl,%bl
    3b0d:	75 8f                	jne    3a9e <printf+0x5e>
    }
  }
}
    3b0f:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b12:	5b                   	pop    %ebx
    3b13:	5e                   	pop    %esi
    3b14:	5f                   	pop    %edi
    3b15:	5d                   	pop    %ebp
    3b16:	c3                   	ret    
    3b17:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    3b32:	e8 59 fe ff ff       	call   3990 <printint>
        ap++;
  ...
  write(fd, &c, 1);
    3b74:	e8 7a fd ff ff       	call   38f3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3b96:	e9 59 ff ff ff       	jmp    3af4 <printf+0xb4>
    ...
    3bc4:	eb 1a                	jmp    3be0 <printf+0x1a0>
          s = "(null)";
    3bc6:	bb 3e 55 00 00       	mov    $0x553e,%ebx
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3beb:	57                   	push   %edi
    3bec:	53                   	push   %ebx
    3bed:	e8 01 fd ff ff       	call   38f3 <write>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c11:	a1 00 a6 00 00       	mov    0xa600,%eax
{
  ...
  bp = (Header*)ap - 1;
    3c1e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3c28:	89 c2                	mov    %eax,%edx
    3c2a:	8b 00                	mov    (%eax),%eax
    3c2c:	39 ca                	cmp    %ecx,%edx
    3c2e:	73 30                	jae    3c60 <free+0x50>
    3c30:	39 c1                	cmp    %eax,%ecx
    3c32:	72 04                	jb     3c38 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c34:	39 c2                	cmp    %eax,%edx
    3c36:	72 f0                	jb     3c28 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3c38:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3c3b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3c3e:	39 f8                	cmp    %edi,%eax
    3c40:	74 30                	je     3c72 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3c42:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3c45:	8b 42 04             	mov    0x4(%edx),%eax
    3c48:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3c4b:	39 f1                	cmp    %esi,%ecx
    3c4d:	74 3a                	je     3c89 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3c4f:	89 0a                	mov    %ecx,(%edx)
  freep = p;
}
    3c51:	5b                   	pop    %ebx
  freep = p;
    3c52:	89 15 00 a6 00 00    	mov    %edx,0xa600
}
    3c58:	5e                   	pop    %esi
    3c59:	5f                   	pop    %edi
    3c5a:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c60:	39 c2                	cmp    %eax,%edx
    3c62:	72 c4                	jb     3c28 <free+0x18>
    3c64:	39 c1                	cmp    %eax,%ecx
    3c66:	73 c0                	jae    3c28 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    3c68:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3c6b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3c6e:	39 f8                	cmp    %edi,%eax
    3c70:	75 d0                	jne    3c42 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    3c72:	03 70 04             	add    0x4(%eax),%esi
    3c75:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3c78:	8b 02                	mov    (%edx),%eax
    3c7a:	8b 00                	mov    (%eax),%eax
    3c7c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3c7f:	8b 42 04             	mov    0x4(%edx),%eax
    3c82:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3c85:	39 f1                	cmp    %esi,%ecx
    3c87:	75 c6                	jne    3c4f <free+0x3f>
    p->s.size += bp->s.size;
    3c89:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3c8c:	89 15 00 a6 00 00    	mov    %edx,0xa600
    p->s.size += bp->s.size;
    3c92:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3c95:	8b 43 f8             	mov    -0x8(%ebx),%eax
    3c98:	89 02                	mov    %eax,(%edx)
}
    3c9a:	5b                   	pop    %ebx
    3c9b:	5e                   	pop    %esi
    3c9c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cac:	8b 3d 00 a6 00 00    	mov    0xa600,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3d27:	a1 00 a6 00 00       	mov    0xa600,%eax
      if((p = morecore(nunits)) == 0)
    3d2c:	83 c4 10             	add    $0x10,%esp
    3d2f:	85 c0                	test   %eax,%eax
    3d31:	75 bd                	jne    3cf0 <malloc+0x50>
        return 0;
  }
}
    3d33:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    3d3c:	c3                   	ret    
    if(p->s.size >= nunits){
    3d3d:	89 c2                	mov    %eax,%edx
    3d3f:	89 f8                	mov    %edi,%eax
    ...
    3d4e:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    3d51:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    3d54:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3d57:	a3 00 a6 00 00       	mov    %eax,0xa600
}
    3d5c:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3d5f:	8d 42 08             	lea    0x8(%edx),%eax
}
    3d62:	5b                   	pop    %ebx
    3d63:	5e                   	pop    %esi
    3d64:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    3d70:	c7 05 00 a6 00 00 04 	movl   $0xa604,0xa600
    3d77:	a6 00 00 
    base.s.size = 0;
    3d7a:	bf 04 a6 00 00       	mov    $0xa604,%edi
    base.s.ptr = freep = prevp = &base;
    3d7f:	c7 05 04 a6 00 00 04 	movl   $0xa604,0xa604
    3d86:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d89:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3d8b:	c7 05 08 a6 00 00 00 	movl   $0x0,0xa608
    3d92:	00 00 00 
    if(p->s.size >= nunits){
    3d95:	e9 32 ff ff ff       	jmp    3ccc <malloc+0x2c>
    3d9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3da0:	8b 0a                	mov    (%edx),%ecx
    3da2:	89 08                	mov    %ecx,(%eax)
