...
main(int argc, char * argv[])
{
  ...
  18:	e8 d3 03 00 00       	call   3f0 <printf>
    shutdown();
  1d:	e8 01 03 00 00       	call   323 <shutdown>
    exit(); //return 0;
  22:	e8 5c 02 00 00       	call   283 <exit>
  27:	66 90                	xchg   %ax,%ax
  29:	66 90                	xchg   %ax,%ax
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 574:	eb 1a                	jmp    590 <printf+0x1a0>
          s = "(null)";
 576:	bb 5e 07 00 00       	mov    $0x75e,%ebx
        while(*s != 0){
 ...
 5c1:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 0c 0a 00 00    	mov    0xa0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a7:	73 4f                	jae    6f8 <malloc+0xa8>
    ...
    if(p == freep)
 6a9:	8b 3d 0c 0a 00 00    	mov    0xa0c,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 0c 0a 00 00       	mov    0xa0c,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 ...
 71e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 10 0a 00 00       	mov    $0xa10,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 742:	00 00 00 
    if(p->s.size >= nunits){
